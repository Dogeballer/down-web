...
class SuiteGlobalParam extends Component {
  state = {
    keys: [0],
  }
    ...
    return (
      <div style={{ width: '100%', display: 'flex' }}>
        <Form.Item wrapperCol={{ span: 24 }} style={{ width: '50%', marginRight: '16px' }}>
          <Input
            placeholder={'请按照"{{{globalParam}}}"格式输入参数名'}
            value={globalParam}
            onChange={(e) => {
              this.setState({
...
export default SuiteGlobalParam
